...
public class ProbeFreshBdfImport {
  ...
  public static void main(String[] args) {
    ...
    try { m.component("comp1").mesh("mesh1").feature("imptest").set("filename", "/Users/eliguli712/DataStructure/numerical_analysis/FEA_meg/applied_forces/__tracked_surface_tet_vol.bdf"); } catch (Exception e) { System.out.println("set file err="+e.getMessage()); }
    pr(m, "source");
    pr(m, "filename");
    ...
    try { m.save("/Users/eliguli712/DataStructure/numerical_analysis/FEA_meg/applied_forces/ProbeFreshBdfImport_Model.mph"); }
    catch (IOException e) { throw new RuntimeException(e); }
  }
}
